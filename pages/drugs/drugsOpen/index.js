    ...
    <div className="">
      <div className="gap-10 flex w-9/12 m-auto mt-10">
        ...
        <div className="w-3/5 text-gray-800">
          ...
          <div className="flex items-center gap-2 mt-5 border-2 bg-green-600 border-green-600 px-10 py-2 text-lg font-semibold cursor-pointer text-white block w-max rounded hover:bg-white hover:text-green-600 transition-all">
